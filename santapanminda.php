...
Plugin URI: http://www.eizil.com/projek/santapan-minda/
Description: Pelbagai Mutiara Kata untuk kegunaan harian.
Version: 1.0.2
...
<?php       
			...
			if($xml) :	
				...
				echo "<em>" . $quote . "</em><br /><span style='float:right; font-size:9px;'> via <a href='http://santapanminda.com' target='_blank'>SM</a></span>";
			else:
				echo "<em>Melakukan kesilapan itu manusia dan memaafkan kesilapan itu ialah kemanusiaan.</em><br /><span style='float:right; font-size:9px;'> via <a href='http://santapanminda.com' target='_blank'>SM</a></span>";
			endif;
?>
